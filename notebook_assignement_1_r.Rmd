...
First downsample the images, because if not, it takes too long to train, removes unnecessary columns too, saves it as an object again
```{r}
...
test_set <- preprocessed_data[5001:nrow(mnist.dat),]
